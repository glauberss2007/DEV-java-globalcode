package lab07_01.src.main.java;
...
public class Conta {
     ...
     */
    public Conta(double saldoInicial, String num, Cliente tit, String ag, int bc) {
        saldo = saldoInicial;
        numero = num;
        titular = tit;
        agencia = ag;
     ...
     *            Banco a qual a agencia pertence
     */
    public Conta(String num, Cliente tit, String ag, int bc) {
